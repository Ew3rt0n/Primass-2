...
public class Definicoes {
        ...
        switch (numDia){
            ...
            case "12":
                resposta = "A personalidade é formada de acordo com dia do nascimento e representa o \"Eu Sou\" mais verdadeiro de cada um, registrando no ser humano as suas qualidades inatas, determinando as suas tendências naturais, as suas particularidades como o selo que será a sua marca por toda a vida refletindo-se em seus dons peculiares. \n\n"+
                        ...
                        "O nativo deste dia, quando quer captar simpatias ou simplesmente fazer novas amizades, é capaz de assumir papel de vítima, mantendo as suas “presas” em constante ansiedade e insegurança, ora pelo apaixonado, ora indiferente e distante. \n" +
                        "Tem natural impaciência e quase sempre se deixa dominar nervosismo, estando sujeito a crises de depressão, insatisfação e se entendia com facilidade. Para evitar este lado negativo da sua personalidade, deve-se manter sempre interessado em algo construtivo, de preferência ligado a atividades intelectuais. \n" +
            ...
            case "16":
                resposta = "A personalidade é formada de acordo com dia do nascimento e representa o \"Eu Sou\" mais verdadeiro de cada um, registrando no ser humano as suas qualidades inatas, determinando as suas tendências naturais, as suas particularidades como o selo que será a sua marca por toda a vida refletindo-se em seus dons peculiares. \n\n"+
                        ...
                        "As frustrações ao longo da vida (que não são poucas), podem levá-lo à obesidade, a ter problemas estomacais, de pele e até algumas doenças imaginárias (hipocondria).";
                break;
            ...
            case "19":
                resposta = "A personalidade é formada de acordo com dia do nascimento e representa o \"Eu Sou\" mais verdadeiro de cada um, registrando no ser humano as suas qualidades inatas, determinando as suas tendências naturais, as suas particularidades como o selo que será a sua marca por toda a vida refletindo-se em seus dons peculiares. \n\n"+
                        ...
                        "Quando quer alguma coisa, é capaz de gestos teatrais e até atitudes extremas e não aceita seguir o tradicional. Amigável e popular, não tem dificuldades para fazer amigos e seduzir as pessoas. Em geral atraente, tem muitos admiradores do sexo oposto. Contudo, se se deixar levar pela instabilidade, as suas experiências amorosas podem ser como andar de montanha-russa, com muitas perdas e sucessos. \n" +
            ...
            case "30":
                resposta = "A personalidade é formada de acordo com dia do nascimento e representa o \"Eu Sou\" mais verdadeiro de cada um, registrando no ser humano as suas qualidades inatas, determinando as suas tendências naturais, as suas particularidades como o selo que será a sua marca por toda a vida refletindo-se em seus dons peculiares. \n\n"+
                        ...
                        "Fora desse lado negativo, normalmente é compreensivo e tolerante com tudo e com todos (apesar de às vezes pensar que está sempre certo). Quando lhe tolhem seus ideais ou frustram seus objetivos, o seu sistema nervoso sofre sobremaneira.";
                break;
            ...
            case "31":
                resposta = "A personalidade é formada de acordo com dia do nascimento e representa o \"Eu Sou\" mais verdadeiro de cada um, registrando no ser humano as suas qualidades inatas, determinando as suas tendências naturais, as suas particularidades como o selo que será a sua marca por toda a vida refletindo-se em seus dons peculiares. \n\n"+
                        ...
                        "Com o seu charme e sua habilidade para irradiar calor humano, atrai as pessoas, seja no trato individual ou público. Como é muito sociável, é um excelente anfitrião e tem compaixão pelos problemas alheios. Normalmente se sente atraído por gente determinada, mas deve tomar cuidado para não se envolver em jogos de poder com os seus parceiros. Normalmente as pessoas nascidas neste dia se esforçam muito para manter os relacionamentos harmoniosos, embora ambos os sexos tenham inclinação à inquietude. Se encontrar a sua cara metade, deve se casar cedo, pois a vida de casado acalma-o. \n" +
    ...
    public String licoes(String numLicoes){
        ...
        switch (numLicoes){
            ...
            case "2":
                resposta = "Em vidas passadas você foi um ser totalmente indisciplinado, negligente e nada colaborador. O dinheiro tinha pouca importância, gastando-o a torto e a direito, sem se importar com o dia de amanhã. \n" +
            ...
            case "3":
                resposta = "Provavelmente “pobre” e sem muito estudo na vida passada, você foi um ser sem qualquer ambição, expressão, imaginação, criatividade, além da falta de vontade de progredir, limitando-se à “vidinha” insignificante, não tendo qualquer talento e confiança em si próprio, mostrando-se, isto sim, nervoso, irritadiço e até violento. \n" +
                        "A Lição a aprender nesta existência é eliminar a timidez, seja ela no falar, representar, escrever ou mesmo tratando com estranhos. Deve cultivar também a imaginação, agir com segurança, criatividade, paciência e sempre positivamente.";
                break;

            case "4":
                resposta = "Provavelmente “preguiçoso” na vida passada deixava tudo a meio caminho; não gostava de receber ordens, de trabalho metódico ou pesado. Tinha também certa dificuldade em terminar o que começava, ou seja, era dispersivo, imprudente e desajeitado. \n" +
            ...
            case "6":
                resposta = "Na vida passada você foi em ser completamente alheio e, digamos, até irresponsável para com obrigações familiares. Não estava nem aí para ajudar familiares doentes e necessitados. \n" +
                        "Nesta atual existência, até que aprenda esta Lição, que é a de ser bom pai (ou mãe), irmão, parente, amigo ou cônjuge, poderá ser forçado a assumir responsabilidades domésticas (cuidar de doentes) ou mesmo prestar serviços a terceiros. Deverá ser compreensivo nessas ocasiões, pois os “parentes” e amigos pouco ou nada farão para ajudá-lo; muito pelo contrário, deverão sobrecarregá-lo com muitas exigências, até que aprenda definitivamente esta crucial Lição.";
                break;

            case "7":
                resposta = "Em outra existência você foi um ser indeciso; buscava o lado espiritual, mas queria ser rico a qualquer custo. Também pouco ou nada fez em matéria educacional, sendo um ser de pouca cultura, sem conhecimento de si próprio e das Leis que regem o Universo. \n" +
            ...
            case "8":
                resposta = "Provavelmente você foi “rico” na vida passada (herdeiro), sem qualquer capacidade ou vontade de ganhar dinheiro. Na verdade, era gastador, esbanjador, pouco se importando quem ganhava o dinheiro; só queria gastá-lo! \n" +
            ...
            case "9":
                resposta = "Você foi na vida passada um ser frio, sem amor e compreensão para com seus semelhantes. Não aparentava qualquer sentimento de afeto; era desumano, indiferente, pouco se importando com os outros. \n" +
                        "Em virtude dessa “apatia” emocional, nesta existência poderá sofrer alguns reveses na vida, como perda de propriedades, longos períodos desempregado, doenças diversas e também desapontamentos com amigos, parentes, sócios, cônjuge ou simplesmente companheiros. \n" +
